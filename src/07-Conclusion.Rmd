...
The framework is scalable to validate any of the real-life scenarios typical of any data environment.  The solution would need to be experimented and validated using different real-life scenarios in the data before implementation.   
...
###Does accuracy improve with increase in Training Data?
